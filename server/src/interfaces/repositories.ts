...
export interface ICandidateRepository {
  ...
  findAll(options: { page: number; limit: number; search: string; isActive?: boolean; sortField?: string; sortOrder?: 'asc' | 'desc' }): Promise<{ data: ICandidate[]; pagination: any }>;
...
export interface IRezulterRepository {
  ...
  getAllRezulters(options: { page: number; limit: number; search: string; isActive?: boolean; sortField?: string; sortOrder?: 'asc' | 'desc' }): Promise<{ data: IRezulter[]; pagination: any }>;
